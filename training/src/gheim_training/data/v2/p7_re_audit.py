...
- ``data/v2_p7_audit_report.json``: machine-readable

Run
---
    uv run python -m gheim_training.data.v2.p7_re_audit
"""
...
from ..p7_audit_openrouter import MODELS as P7_AUDIT_MODELS
...
REPORT_PATH = Path("data/v2_p7_audit_report.json")
