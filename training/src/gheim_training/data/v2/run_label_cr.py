...
2. Filters to CR chunks using
   :func:`gheim_training.data.v2.cr_identify.is_commercial_register`.
3. Re-labels each filtered chunk with Qwen 3.6 35B-A3B using the
   CR-aware prompt
   (:func:`gheim_training.data.v2.cr_prompts.build_cr_messages`),
...
Run
---
    uv run python -m gheim_training.data.v2.run_label_cr \\
...
from ..gemma.labeler import SCHEMA, _parse_json, _verify_and_locate
from ..qwen.client import DEFAULT_MODEL, QwenClient
