...
- ``data/balanced_train.jsonl``
- ``data/balanced_val.jsonl``
- ``data/balanced_test.jsonl``

and writes a HF DatasetDict at ``data/built/`` with the
...
Run
---
    uv run python -m gheim_training.data.build_hf
"""
...
IN_TRAIN = Path("data/balanced_train.jsonl")
