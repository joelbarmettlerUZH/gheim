 ...
 *
 *  The calibrated default (`oBias=0.5`) is Pareto-clean on gheim-ch-560m:
 *  +0.27pp test char-F1 with no probe cost (91.5% perfect at both 0.0
 *  and 0.5). See eval/calibration_sweep.json. */
