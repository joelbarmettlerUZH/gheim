...
per (lang, cat); the right-most three columns give the per-category
marginals (char, strict, int8-quantisation $\Delta$) along with the
gold-span support; the bottom three rows give the per-language
marginals (char F\textsubscript{1}, strict F\textsubscript{1},
chunk count).
...
columns give per-category marginals: ``Char'' and ``Strict'' are the
two F\textsubscript{1} headline metrics, ``Quant.~$\Delta$'' is the
change under int8 quantisation relative to the fp32 strict cell, and
$n_\text{gold}$ is the total gold-span support across all languages.
Bottom rows give the per-language marginals. Smallest cell:
...
\small
\begin{tabular}{l r r r r r @{\hspace{1em}} r r r r}
\toprule
                            & \multicolumn{5}{c}{Char F\textsubscript{1} per language}        & \multicolumn{4}{c}{Per-category marginals} \\
\cmidrule(lr){2-6}\cmidrule(l){7-10}
Category                    & de\_ch & fr\_ch & it\_ch & rm    & en    & Char  & Strict & Quant.~$\Delta$ & $n_\text{gold}$ \\
\midrule
\texttt{account\_number}    & 0.932  & 0.717  & 0.660  & 0.169 & 0.994 & 0.765 & 0.669  & $-0.053$ & 502 \\
\texttt{private\_address}   & 0.890  & 0.870  & 0.915  & 0.825 & 0.973 & 0.889 & 0.782  & $-0.021$ & 3{,}507 \\
\texttt{private\_date}      & 0.943  & 0.934  & 0.952  & 0.888 & 0.909 & 0.939 & 0.922  & $-0.007$ & 9{,}678 \\
\texttt{private\_email}     & 0.988  & 0.994  & 0.999  & 0.992 & 0.999 & 0.994 & 0.987  & $-0.003$ & 1{,}712 \\
\texttt{private\_person}    & 0.938  & 0.948  & 0.962  & 0.897 & 0.951 & 0.944 & 0.915  & $-0.006$ & 14{,}726 \\
\texttt{private\_phone}     & 0.989  & 0.985  & 0.993  & 0.995 & 0.997 & 0.990 & 0.986  & $-0.002$ & 3{,}329 \\
\texttt{private\_url}       & 0.992  & 0.994  & 0.994  & 0.958 & 0.980 & 0.992 & 0.947  & $-0.002$ & 3{,}991 \\
\texttt{secret}             & 0.999  & 1.000  & 0.999  & 1.000 & 1.000 & 1.000 & 0.996  & $+0.002$ & 1{,}104 \\
\midrule
